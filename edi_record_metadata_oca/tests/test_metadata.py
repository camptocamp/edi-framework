...
class TestEDIMetadata(EDIBackendCommonTestCase):
    ...
    def test_fields(self):
        self.exc_record.set_edi_metadata({"foo": "baz", "bar": "waa"})
    ...
    def test_no_store(self):
        ...
        self.assertFalse(self.exc_record.get_edi_metadata())
    ...
    def test_store(self):
        ...
        self.assertEqual(self.exc_record.get_edi_metadata(), expected)
